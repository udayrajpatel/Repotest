...
<body
	...
	<div class="section section-signup page-header"
		style="background-image: url('/assets/img/bg2.jpg'); min-height: 100vh ">
		<div class="container">
			<div class="row" style="margin-left: 70vh">
			
				<div class="col-lg-4 col-md-6 ml-auto mr-auto ">
					<div class="card card-login card w-100">
						<form class="form" method="post" action="<%=ORSView.ROLE_CTL%>">
							...
							<div class="alert alert-danger"
								style="line-height: 3px; margin-left: 1px; margin-right: 10px;">
								<div class="container" style="text-align: left;">
									<div class="alert-icon">
							...
							<div class="card-body">
								...
								<div class="input-group">
									...
									<textarea type="text" class="form-control" style="min-width: 108%"
							...
							<div class="row">
								...
								<div class="col-md-12 ml-auto d-flex justify-content-center" style="margin-top:8%">
