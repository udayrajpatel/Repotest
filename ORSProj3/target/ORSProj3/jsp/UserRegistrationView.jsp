...
<!-- ng-app="720" ng-controller="TestController as ctrl" -->
<body 
					...
					<div class="card card-login pb-2" style="margin-top: 200px">
						...
						<form class="form" method="POST"
							...
							<div class="card-header card-header-primary text-xs-left">
								...
								<h4 class="card-title" style="margin-left: 3vh">User Registration</h4>
							...
							<div class="card-body">
								...
								<div class="input-group">
									...
									<span class="text-danger pt-3" data-toggle="tooltip"
										data-placement="left"
										title="<%=ServletUtility.getErrorMessage("login", request)%>">
