							...
							<div class="row d-inline-flex align-item-center">
								<div class="col-6">
									<button class="btn  btn-info "
										style="border-radius: 10px; margin-top: 32px" name="operation"
										type="submit" value="<%=RoleListCtl.OP_SEARCH%>">
										<i class="fa fa-search-plus" aria-hidden="true"></i><b
											style="font-size: 15px;">Search</b>
									</button>

									<button class="btn btn-info col-md-offset-5"
										style="border-radius: 10px; margin-top: 32px" name="operation"
										type="submit" value="<%=RoleListCtl.OP_RESET%>">
				...
				<div class="col-12">
					<div class="row">
						<div class="col-md-12 d-flex justify-content-center">
							...
							<button class="btn btn-rose col-lg-1 col-sm-2 col-md-offset-5"
								type="submit" name="operation" value="<%=RoleListCtl.OP_NEW%>">
