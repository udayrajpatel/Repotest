...
//            dto.setId(1L); 
            dto.setFirstName("Bhawana"); 
            dto.setLastName("patel"); 
            dto.setDob(sdf.parse("05/12/1990")); 
            dto.setMobileNo("9826556778"); 
            dto.setEmail("uday@gmail.com"); 
            dto.setCollegeId(1L); 
    ...
    public static void testUpdate() { 
        ...
        try { 
            ...
            dto.setEmail("shrma@gmail.com"); 
            dto.setCollegeId(3L); 
            dto.setCollegeName("LNCT"); 
            model.update(dto); 
            StudentDTO updatedDTO = model.findByPK(1L); 
            if (!"Anna".equals(updatedDTO.getFirstName())) { 
