	...
	<div class="container-fluid" style="margin-top: 125px;">
		...
		<form action="<%=ORSView.COURSE_LIST_CTL%>" method="post">
            ...
            <div class="col-lg-3 col-sm-4 mt-4">
              ...
              <div class="col-6"><button class= "btn  btn-info " style="border-radius:10px;"
              name="operation" type="submit" value="<%=CourseListCtl.OP_SEARCH%>">
              <i class="fa fa-search-plus" aria-hidden="true" ></i><b style="font-size: 15px;">Search</b></button></div>
              <div class="col-6"><button class="btn btn-default " style="border-radius:10px;"
               name="operation" type="submit" value="<%=CourseListCtl.OP_RESET%>">
               <i class="fa fa-refresh" aria-hidden="true" ></i>&emsp;<b style="font-size: 15px;">Reset</b></button></div>
              </div>
          </div>
			</div>
		...
		<div class="row">
            <div class="col-md-12 d-flex justify-content-center">
              ...
              value="<%=CourseListCtl.OP_PREVIOUS%>" <%=pageNo > 1 ? "" : "disabled"%>><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>&emsp;Prev
               </button>
              <button class="btn btn-rose col-lg-1 col-sm-6" type="submit" name="operation" value="<%=CourseListCtl.OP_NEW%>"><i class="fa fa-plus-circle" aria-hidden="true"></i>&emsp;Add</button>
              <button class="btn btn-primary col-lg-1 col-sm-2" type="submit" name="operation" 
              value="<%=CourseListCtl.OP_NEXT%>" <%=(nextPageSize != 0) ? "" : "disabled"%>>Next&emsp;<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
            </div>
          </div>
		</div>
					<%
