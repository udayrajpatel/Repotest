	...
	<div class="container-fluid" style="margin-top: 100px;">
		...
		<form action="<%=ORSView.USER_LIST_CTL%>" method="post">
			<div class="row d-flex justify-content-center">
				...
				<div class="col-12 d-flex justify-content-center" style="min-height:70px;">
					<%
					...
					<div class="row d-flex justify-content-center">
						...
						<div class="col-lg-3 col-sm-4 mt-4">
							<div class="row d-inline-flex align-item-cenr">
								...
								<div class="col-6">
									<button class="btn f btn-default" style="border-radius: 1rem"
										name="operation" type="submit"
					...
					<table class="table table-striped table-hover bg-light">
						...
						<tbody>
							<tr>
								...
								<td class="d-flex justify-content-center"> <button class="btn btn-link text-primary " type="submit" name="operation" value="<%=UserListCtl.OP_DELETE%>" <%if (userDto.getId() == dto.getId() || dto.getRoleId() == RoleDTO.ADMIN) {%>
									<%="disabled"%> <%}%>>
										<i class="fa fa-trash" aria-hidden="true"></i></button></td>
								<td class="text-center"><a href="UserCtl?id=<%=dto.getId()%>"
									<%if (userDto.getId() == dto.getId() || dto.getRoleId() == RoleDTO.ADMIN) {%>
