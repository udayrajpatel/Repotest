                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                         ...
                         <h3 class="text-center default-text py-3"><u><%=(id==0)? "Add Marksheet": "Update Marksheet" %></u></h3>
                              <hr color="black">  
    ...
    <%} %>                            
            ...
            <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(dto.getModifiedDatetime())%>">
                        ...
                        <input type="text" placeholder="Enter rollNo" class="form-control border" 
                               style="background-color:white" name="rollNo" value="<%=DataUtility.getStringData(dto.getRollNo())%>">
                                </div>
                           ...
                           <h6 class="paddingclass" style="color: #fff " >Student Name<font color="red">*</font></h6>
                          <div class="input-group">
                             <div class="input-group-prepend">
                            ...
                            <h6 class="paddingclass" style="color: #fff " >Physics<font color="red">*</font></h6>
                            <div class="input-group">
                            <div class="input-group-prepend">
                               <span class="input-group-text" style="background-color:white-space;"><i  class="fa fa-book"></i></span>
                                 </div>
                        <input onkeypress="return isNumberKey(event)" type="text" placeholder="Enter physics marks" class="form-control border" 
                               style="background-color:white" name="physics" value="<%=DataUtility.getStringData(dto.getPhysics()).equals("0")?"":DataUtility.getStringData(dto.getPhysics())%>">
                                </div>
							<font color="red"><%=ServletUtility.getErrorMessage("physics",request) %> </font>
                             ...
                             <h6 class="paddingclass" style="color: #fff " >Chemistry<font color="red">*</font></h6>
                           <div class="input-group">
                            <div class="input-group-prepend">
                               <span class="input-group-text" style="background-color:white-space;"><i   class="fa fa-book"></i></span>
                                 </div>
                        <input onkeypress="return isNumberKey(event)" type="text" placeholder="Enter chemistry marks" class="form-control border" 
                               style="background-color:white" name="chemistry" value="<%=DataUtility.getStringData(dto.getChemistry()).equals("0")?"":DataUtility.getStringData(dto.getChemistry())%>">
                                </div>
							<font color="red" ><%=ServletUtility.getErrorMessage("chemistry",request) %> </font>
                        
                          
                            
                             <h6 class="paddingclass"  style="color: #fff " >Maths<font color="red">*</font></h6>
                          <div class="input-group">
                            <div class="input-group-prepend">
                               <span class="input-group-text" style="background-color:white-space;"><i   class="fa fa-book"></i></span>
                                 </div>
                        <input onkeypress="return isNumberKey(event)" type="text" placeholder="Enter maths marks" class="form-control border" 
                               style="background-color:white" name="maths" value="<%=DataUtility.getStringData(dto.getMaths()).equals("0")?"":DataUtility.getStringData(dto.getMaths())%>">
                                </div>
