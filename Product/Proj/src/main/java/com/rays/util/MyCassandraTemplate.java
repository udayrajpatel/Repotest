...
public class MyCassandraTemplate {
	...
	/*   *//**
	  ...
	  cassandraTemplate.selectOneById(claz, (Class<T>) id); }
	 ...
	 /**
	  ...
	  public <T> void deleteById(Class<?> id, Class<T> claz) {
	 ...
	 /**
	  ...
	  public void delete(Object entity) { cassandraTemplate.delete(entity); }
	 ...
	 /**
	  ...
	  public <T> void deleteAll(Class<T> claz) { cassandraTemplate.delete(claz);
	  }
	 ...
	 /**
	  ...
	  public <T> List<T> findAll(Class<T> claz) { return (List<T>)
	  cassandraTemplate.selectAll(claz); }
	 ...
	 */
	  ...
	  public <T> boolean exists(Object id, Class<T> claz) { return
	  cassandraTemplate.exists(claz, id); }
