...
public class CollegeServiceSpringImpl implements CollegeServiceInt {
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project0.service.CollegeServiceInt#add(in.co.rays.project0.dto.CollegeDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project0.service.CollegeServiceInt#update(in.co.rays.project0.dto.CollegeDTO)
	 */
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project0.service.CollegeServiceInt#search(in.co.rays.project0.dto.CollegeDTO)
	 */
	@Transactional(readOnly = true)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project0.service.CollegeServiceInt#search(in.co.rays.project0.dto.CollegeDTO, int, int)
	 */
	@Transactional(readOnly = true)
