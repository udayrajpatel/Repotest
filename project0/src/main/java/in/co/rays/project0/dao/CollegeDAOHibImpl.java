...
public class CollegeDAOHibImpl implements CollegeDAOInt {
	 ...
	 * 
	 * @see
	 * in.co.rays.project0.dao.CollegeDAOInt#add(in.co.rays.project0.dto.CollegeDTO)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.rays.project0.dao.CollegeDAOInt#update(in.co.rays.project0.dto.
	 * CollegeDTO)
	 */
	...
	public CollegeDTO findByName(String name) {
		// TODO Auto-generated method stub
		CollegeDTO dto = null;
		List list = (List) sessionFactory.getCurrentSession().createCriteria(CollegeDTO.class)
	...
	public CollegeDTO findByPK(long pk) {
		// TODO Auto-generated method stub
		CollegeDTO dto = sessionFactory.getCurrentSession().get(CollegeDTO.class, pk);
		return dto;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.rays.project0.dao.CollegeDAOInt#search(in.co.rays.project0.dto.
	 * CollegeDTO, int, int)
	 */
