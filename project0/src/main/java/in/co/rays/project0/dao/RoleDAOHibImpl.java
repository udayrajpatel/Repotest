...
public class RoleDAOHibImpl implements RoleDAOInt {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.rays.project0.dao.RoleDAOInt#add(in.co.rays.project0.dto.RoleDTO)
	 */
	 ...
	 * 
	 * @see
	 * in.co.rays.project0.dao.RoleDAOInt#update(in.co.rays.project0.dto.RoleDTO)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.rays.project0.dao.RoleDAOInt#delete(long)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.rays.project0.dao.RoleDAOInt#findByName(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.rays.project0.dao.RoleDAOInt#findByPK(long)
	 */
	public RoleDTO findByPK(long pk) {
		log.debug("RoleDAO Find by PK Started");
		RoleDTO dto = null;
		dto = sessionFactory.getCurrentSession().get(RoleDTO.class, pk);
	 ...
	 * 
	 * @see
	 * in.co.rays.project0.dao.RoleDAOInt#search(in.co.rays.project0.dto.RoleDTO,
	 * int, int)
	 */
	public List search(RoleDTO dto, int pageNo, int pageSize) throws DataAccessException {
		...
		// Criteria
		// criteria=sessionFactory.getCurrentSession().createCriteria(RoleDTO.class);
		if (dto != null) {
			if (dto.getId() > 0) {
