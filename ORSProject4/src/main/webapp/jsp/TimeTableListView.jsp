	...
	<div align="center" style="height: 620px;">
		...
		<form action="<%=ORSView.TIME_TABLE_LIST_CTL%>" method="post"
			...
			<%
				...
				List marksheetList=(List) request.getAttribute("mark");
			%>
			...
			<table width="100%">
				<tr>
					<td align="center"><label>Course Name :</label> <%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), courseList)%>
						...
						&emsp; &emsp;
					<%-- 	<label>Rollno :</label> <%=HTMLUtility.getList("RollId", String.valueOf(bean.getId()), marksheetList)%>&emsp; &emsp; --%>
					 
					    <label>Exam Date : </label>
					    <input type="text"
						name="examDate" id="datesun" readonly="readonly"
						placeholder="Must be a Date"
			...
			<inpu type="hidden" name="pageSize" value="<%=pageSize%>">
